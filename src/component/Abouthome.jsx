...
function Abouthome() {
  ...
  return (
    ...
    <div className="lg:pt-32 py-10 aboutus-home">
      <div className="">
        <h1 className="xl:text-6xl text-3xl mx-auto text-center font-extrabold mb-4 font-proracing tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">
          ABOUT US
        </h1>
