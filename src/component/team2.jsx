...
export default function TeamPage() {
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 text-gray-100 font-exo-2">
      <div className="max-w-7xl mx-auto">
        <motion.h1 
          className="text-5xl font-bold text-center text-blue-400 mb-12 font-orbitron"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {teamData.map((team, index) => (
          ...
          >
            <h2 className="text-4xl font-bold text-center text-blue-300 mb-6 font-orbitron">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8 text-center">
              <div>
                <h3 className="text-xl font-semibold text-blue-300 font-orbitron">Captain</h3>
                <p className="text-lg text-gray-100">{team.captain}</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-blue-300 font-orbitron">Vice Captain</h3>
            ...
            {team.mentors && (
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-center text-blue-400 mb-4 font-orbitron">
                  <FaUsers className="inline mr-2 text-blue-400" />
                  Mentors
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {team.mentors.map((mentor, mentorIndex) => (
                    <div key={mentorIndex} className="bg-blue-800/25 p-3 rounded-lg text-center border border-blue-600">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 ">
              {Object.entries(team.subTeams).map(([subTeamName, members], subTeamIndex) => (
                <div key={subTeamIndex} className="bg-blu p-4 rounded-lg shadow-lg border border-blue-600">
                  <h3 className="text-xl font-bold text-blue-300 mb-4 font-orbitron">{subTeamName}</h3>
                  <div className="grid grid-cols-2 gap-2">
                    {members.map((member, memberIndex) => (
                      <div key={memberIndex} className="bg-blue-800/25 p-2 rounded border border-blue-700">
