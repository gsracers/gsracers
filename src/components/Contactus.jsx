    ...
    <footer
      ...
      <div className="mx-6 py-10 text-center md:text-left flex items-center  justify-center w-full">
         <div className="grid-1 grid gap-8 md:grid-cols-2 justify-center items-center place-items-center content-center overflow-clip lg:grid-cols-3">
                ...
                <div className="">
                <h6
                  className="mb-4 flex p-2 justify-center font-semibold uppercase md:justify-start">
                  USEFUL LINKS
                </h6>
                <p className="mb-4">
                  <a className=" "
          ...
          <div className=''>
                 <h6
                   className="mb-4 flex justify-center font-semibold uppercase xl:justify-end">
                   gs racers
                 </h6>
